...
_vPatrol =    ["rhs_tigr_m_vdv","RHS_Mi8mt_vvsc","rhs_uaz_open_vdv"];
...
_vfs = [
  ...
  "rhs_uaz_open_vdv", // UAZ
  "rhs_gaz66o_msv", // Military Truck
  "B_G_Offroad_01_armed_F", // Armed UAZ
...
vehFIA pushBackUnique statMG;
vehFIA pushBackUnique statAT;
vehFIA pushBackUnique statAA;
vehFIA pushBackUnique statMortar;
