...
_precisePosition = [_this,9,true,[true]] call bis_fnc_param;
_maxVehicles = [_this,10,10e10,[123]] call bis_fnc_param;

//Fetch the random controls.
private ["_minUnits", "_chance"];
_minUnits = [_randomControls, 0, -1, [0]] call BIS_fnc_param;
_chance = [_randomControls, 1, 1, [0]] call BIS_fnc_param;
