...
_veh addEventHandler ["killed",{if (side (_this select 1) == side_blue) then {[2,-2] remoteExec ["prestige",2]; [-5,5,position (_this select 0)] remoteExec ["citySupportChange",2]}}];
