...
if (_type == "air") then {
	...
	[_grpVeh2, _landpos1, _posOrig, 25*60, _grpDis2, _mrk] spawn transportTroops;
}
...
// ground convoy
	...
	// spawn dismount script
	[_grpVeh1, _dest, _posOrig, 25*60, _grpDis1, _mrk] spawn transportTroops;
	...
	[_grpVeh2, _pos3, _posOrig, 25*60, _grpDis2, _mrk] spawn transportTroops;
};
