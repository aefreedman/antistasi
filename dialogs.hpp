...
class HQ_button_back: RscButton
{
	...
	w = 0.06 * safezoneW;//0.175015
	h = 0.05 * safezoneH;
	action = "closeDialog 0; if (player == Stavros) then {_nul = createDialog ""radio_comm_commander""} else {_nul = createDialog ""radio_comm_player""};";
};
...
class HQ_button_resetHQ: RscButton // R3
{
	idc = -1;
	text = "Reset HQ Location"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
	y = 0.514003 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
...
class HQ_button_exit: RscButton
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if ((player == Stavros) or (not(isPlayer Stavros))) then {[[""PR"",false,true],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
};
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT END
////////////////////////////////////////////////////////
...
class HQ_button_back: RscButton
{
	...
	w = 0.06 * safezoneW;//0.175015
	h = 0.05 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {_nul = createDialog ""game_options_commander"";} else {_nul = createDialog ""game_options_player"";}";
};
class HQ_button_Gsquad: RscButton
{
	idc = -1;
...
class btn_exp_smC: RscButton
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 300 Euros on a small bag of explosives.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""expLight"", 300] remoteExec [""buyGear"",2];}";
};
class btn_exp_smM: RscButton
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 300 Euros on a small bag of mines.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""expHeavy"", 300] remoteExec [""buyGear"",2];}";
};
class btn_exp_lgC: RscButton
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 800 Euros on a large bag of explosives.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""expLight"", 800] remoteExec [""buyGear"",2];}";
};
class btn_exp_lgM: RscButton
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 800 Euros on a large bag of mines.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""expHeavy"", 800] remoteExec [""buyGear"",2];}";
};
class btn_exp_smW: RscButton // L3
{
	idc = -1;
	text = "Some Weapons"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
	y = 0.514003 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 1000 Euros on a small cache of weapons.";
	action = "closeDialog 0;_nul = createDialog ""wpns_small"";";
};
class btn_exp_lgW: RscButton // L4
{
	idc = -1;
	text = "Many Weapons"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
	y = 0.612025 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 2500 Euros on a large cache of weapons.";
	action = "closeDialog 0;_nul = createDialog ""wpns_large"";";
};
class btn_exp_smA: RscButton // R3
{
	idc = -1;
	text = "Some Accessories"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
	y = 0.514003 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 500 Euros on a small cache of weapon accessories.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""aCache"", 500] remoteExec [""buyGear"",2];}";
};
class btn_exp_lgA: RscButton // R4
{
	idc = -1;
	text = "Many Accessories"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
	y = 0.612025 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 5000 Euros on a large cache of weapon accessories.";
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""aCache"", 5000] remoteExec [""buyGear"",2];}";
};
class btn_exp_smR: RscButton // M5
{
	idc = -1;
	text = "Some Ammo"; //--- ToDo: Localize;
	x = 0.37749 * safezoneW + safezoneX;
	y = 0.710047 * safezoneH + safezoneY;
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	tooltip = "Spend 300 Euros on some ammo for your primary weapon.";
	//action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""resupply"", 300, player] remoteExec [""buyGear"",2];}";
	action = "closeDialog 0;";
};
	};
};
...
class HQ_button_back: RscButton
{
	...
	w = 0.06 * safezoneW;//0.175015
	h = 0.05 * safezoneH;
	action = "closeDialog 0;_nul = createDialog ""exp_menu"";";
};
class HQ_button_AT: RscButton // L1
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""ASRifles"", 1000] remoteExec [""buyGear"",2];}";
};
class HQ_button_AA: RscButton // R1
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Pistols"", 1000] remoteExec [""buyGear"",2];}";
};
class HQ_button_mortar: RscButton // L2
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Machineguns"", 1000] remoteExec [""buyGear"",2];}";
};
class HQ_button_cman: RscButton // R2
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Sniper Rifles"", 1000] remoteExec [""buyGear"",2];}";
};
class HQ_button_lantern: RscButton // L3
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Launchers"", 1000] remoteExec [""buyGear"",2];}";
};
class HQ_button_AAs: RscButton // R3
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Random"", 1000] remoteExec [""buyGear"",2];}";
};
	};
};
...
class HQ_button_AT: RscButton // L1
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""ASRifles"", 2500] remoteExec [""buyGear"",2];}";
};
class HQ_button_AA: RscButton // R1
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Pistols"", 2500] remoteExec [""buyGear"",2];}";
};
class HQ_button_mortar: RscButton // L2
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Machineguns"", 2500] remoteExec [""buyGear"",2];}";
};
class HQ_button_cman: RscButton // R2
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Sniper Rifles"", 2500] remoteExec [""buyGear"",2];}";
};
class HQ_button_lantern: RscButton // L3
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Launchers"", 2500] remoteExec [""buyGear"",2];}";
};
class HQ_button_AAs: RscButton // R3
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;if (player == Stavros) then {[expCrate, ""Random"", 2500] remoteExec [""buyGear"",2];}";
};
	};
};
...
class HQ_button_civplus: RscButton // L1
{
	idc = -1;
	text = "Civ Config"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_civless: RscButton // L2
{
	idc = -1;
	text = "Resign Comm.Career"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_music: RscButton // L3
{
	idc = -1;
	text = "Music ON/OFF"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_garbageclean: RscButton // R1
{
	idc = -1;
	text = "Garbage Clean"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
...
class HQ_button_loadgame: RscButton // R3
{
	idc = -1;
	text = "Reinit UI \ Radio"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
...
class HQ_button_savegame: RscButton // R2
{
	idc = -1;
	text = "Persistent Save"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
...
class HQ_button_fpsplus: RscButton // L4
{
	idc = -1;
	text = "FPS Limiter"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_com_menu: RscButton // L5
{
	idc = -1;
	text = "Commander Menu"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_resync: RscButton // R5
{
	idc = -1;
	text = "Resync Arsenal"; //--- ToDo: Localize;
	x = 0.482498 * safezoneW + safezoneX;
	...
	tooltip = "Use this if items disappeared from the virtual(!) arsenal.";
	//action = "closeDialog 0;if (player == stavros) then {[""resyncArsenal.sqf"",""BIS_fnc_execVM""] call BIS_fnc_MP;};";
	action = "closeDialog 0;if (player == stavros) then {[] remoteExec [""resyncArsenal"", 2];};";
};
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT END
////////////////////////////////////////////////////////
...
class HQ_button_DES: RscButton // L3
{
	idc = -1;
	text = "Vehicle Manager"; //--- ToDo: Localize;
	x = 0.272481 * safezoneW + safezoneX;
...
class HQ_button_PM: RscButton // M5
{
	idc = -1;
...
{
	idc = -1;
	text = "Do you want to reset HQ?"; //--- ToDo: Localize;
	x = 0.254979 * safezoneW + safezoneX;
	y = 0.233941 * safezoneH + safezoneY;
	w = 0.425038 * safezoneW;
	h = 0.18 * safezoneH;//28
...
class HQ_button_Gsquad: RscButton
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;[] spawn buildHQ";
};
class HQ_button_Gstatic: RscButton
{
	idc = -1;
