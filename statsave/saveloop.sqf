...
{
_pospuesto = getMarkerPos _x;
_arrayCampsTony = _arrayCampsTony + [_pospuesto];
} forEach campsTony;

["campsTony", _arrayCampsTony] call fn_SaveStat;
