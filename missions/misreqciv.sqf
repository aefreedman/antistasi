...
if ((server getVariable "civActive") > 1) exitWith {if (!_silencio) then {[[Stranger,"globalChat","How about you prove yourself first by doing what I told you to do..."],"commsMP"] call BIS_fnc_MP}};
