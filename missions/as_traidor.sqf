...
_tsk = ["AST",[side_blue,civilian],[format ["A traitor has scheduled a meeting with USSR in %1. Kill him before he provides enough intel to give us trouble. Do this before %2:%3. We don't where exactly this meeting will happen. You will recognise the building by the nearby Offroad and USSR presence.",_nombredest,numberToDate [2035,_fechalimnum] select 3,numberToDate [2035,_fechalimnum] select 4],"Kill the Traitor",_marcador],_posTsk,"CREATED",5,true,true,"Kill"] call BIS_fnc_setTask;
