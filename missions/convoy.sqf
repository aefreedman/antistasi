...
_source = "";
if (count _this < 3) then {_source = "auto"} else {_source = _this select 2};
...
if (_source == "city") then {
  _tiposConvoy = ["Supplies","Supplies","Supplies","Supplies","Supplies","Supplies","Money"];
};

// if an array of specific types is supplied, use it
if (count _this > 3) then {_tipoConvoy = _this select 3};
