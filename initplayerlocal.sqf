...
if (hayXLA) then {
	...
	caja addAction ["Arsenal", {["Open",[false,caja,player,true]] call xla_fnc_arsenal;},[],6,true,false,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])",5];
} else {
...
// brute force solution to locking vehicles that are local to clients
fnc_lockVehicle = {
